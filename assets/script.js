...
function displayForecast(data) {
  ...
  for (let i = 1; i < data.list.length; i += 8) {
    ...
    if (dayData) {
      ...
      const dateTimestamp = dayData.dt * 1000; // Convert Unix timestamp to milliseconds
      ...
      // Create a div for each day's forecast and append it to the forecast section using jQuery
      const forecastItem = $(`
